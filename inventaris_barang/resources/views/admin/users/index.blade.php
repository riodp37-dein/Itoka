...
<head>
    ...
    <title>Kelola Akun - Sistem Inventaris</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-grid { display: grid; grid-template-columns: 0.95fr 1.05fr; gap: 24px; align-items: start; }
        ...
        .success-message { background-color: #E8F5E9; color: #2E7D32; padding: 12px 15px; border-radius: 10px; margin-bottom: 20px; font-size: 14px; border-left: 4px solid #2E7D32; }
        ...
        .primary-btn { padding: 12px 18px; background-color: #1E3A8A; color: #FFFFFF; border: none; border-radius: 10px; cursor: pointer; font-size: 14px; font-weight: 600; }
        .table-container { overflow-x: auto; }
        table { width: 100%; border-collapse: collapse; }
        table th { background-color: #1E3A8A; color: #FFFFFF; padding: 12px; text-align: left; font-size: 14px; }
        table td { padding: 12px; border-bottom: 1px solid #E5E7EB; font-size: 14px; color: #1F2937; vertical-align: middle; }
        .role-badge { display: inline-block; padding: 6px 10px; border-radius: 999px; font-size: 12px; font-weight: 700; text-transform: capitalize; }
        .role-admin { background-color: #DBEAFE; color: #1D4ED8; }
        .role-pimpinan { background-color: #FEF3C7; color: #B45309; }
        .role-karyawan { background-color: #DCFCE7; color: #15803D; }
        .action-buttons { display: flex; gap: 8px; }
        .btn-link, .btn-delete { display: inline-flex; align-items: center; justify-content: center; padding: 8px 12px; border-radius: 8px; font-size: 13px; text-decoration: none; cursor: pointer; }
        .btn-link { background-color: #EFF6FF; color: #1D4ED8; border: 1px solid #BFDBFE; }
        .btn-delete { background-color: #FEF2F2; color: #DC2626; border: 1px solid #FECACA; }
        .muted { color: #6B7280; font-size: 13px; }
        @media (max-width: 1200px) { .page-grid { grid-template-columns: 1fr; } }
        ...
        <div class="content">
            ...
            <div class="page-grid">
                ...
                <div class="card">
                    ...
                    <p class="muted" style="margin-bottom: 18px;">Admin dapat mengubah data akun, role, password, atau menghapus akun yang tidak dipakai.</p>
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4">Belum ada akun pengguna.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
